...
Complex *fftw_input = NULL;
Complex *fftw_input2 = NULL;
Complex *fftw_output = NULL;
Complex *fftw_output2 = NULL;
fftw_plan pf, pi, pi2;


void create_plan(size_t xdim)
{
    fftw_input   = (Complex*) fftw_malloc(sizeof(Complex) * xdim);
    fftw_input2  = (Complex*) fftw_malloc(sizeof(Complex) * xdim);
    fftw_output  = (Complex*) fftw_malloc(sizeof(Complex) * xdim);
    fftw_output2 = (Complex*) fftw_malloc(sizeof(Complex) * xdim);
    
    pf  = fftw_plan_dft_1d(xdim, reinterpret_cast<fftw_complex*>(fftw_input), reinterpret_cast<fftw_complex*>(fftw_output), FFTW_FORWARD,  FFTW_PATIENT);
    pi  = fftw_plan_dft_1d(xdim, reinterpret_cast<fftw_complex*>(fftw_output), reinterpret_cast<fftw_complex*>(fftw_input), FFTW_BACKWARD, FFTW_PATIENT);
    pi2 = fftw_plan_dft_1d(xdim, reinterpret_cast<fftw_complex*>(fftw_output2), reinterpret_cast<fftw_complex*>(fftw_input2), FFTW_BACKWARD, FFTW_PATIENT);
...
inline void fftwdiff_once(double *in_arr, double *dfdx, double *d2fd2x, const size_t xdim, double period)
{
    ...
    memcpy(fftw_output2, fftw_output, xdim * sizeof(Complex));
